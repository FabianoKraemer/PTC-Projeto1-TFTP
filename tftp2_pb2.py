...
RRQ = _reflection.GeneratedProtocolMessageType('RRQ', (_message.Message,), dict(
  DESCRIPTOR = _RRQ,
  __module__ = 'tftp2_pb2'
  # @@protoc_insertion_point(class_scope:tftp2.RRQ)
  ))
_sym_db.RegisterMessage(RRQ)

WRQ = _reflection.GeneratedProtocolMessageType('WRQ', (_message.Message,), dict(
  DESCRIPTOR = _WRQ,
  __module__ = 'tftp2_pb2'
...
MKDIR = _reflection.GeneratedProtocolMessageType('MKDIR', (_message.Message,), dict(
  DESCRIPTOR = _MKDIR,
  __module__ = 'tftp2_pb2'
